...
// просто переключить и пересобрать
#define _REVISION_DEVICE			207		//2.07
//#define _REVISION_DEVICE			208		//2.08			добавлены GGIO_INGGIO1_Ind25, GGIO_INGGIO1_Ind26
...
#define MB_Size_ErrorNote			54			// число слов в одной аварии
...
#define MB_Addr_ConfigSW	   	0x1000			// конфигурация выключателя
#define MB_offset_ConfigSW 		0x00
#define MB_Size_ConfSW			15				// 14 слов
#define MB_Size_ConfigSW			15
...
// конфигурация АПВ ----------------------------------------------
#define MB_Addr_ConfigAPW	   	0x100E			// конфигурация АПВ
#define MB_Size_ConfigAPW		7				// 6 слов
...
#define MB_Addr_ConfigAWR	   	0x1014			// конфигурация АВР
#define MB_Size_ConfigAWR		13				// 10 слов + 2 слова ЛЗШ
#define MB_offset_ConfAWR		0x00			// конфигурация АВР
#define MB_offset_InBlok		0x01			// вход блокировки

#define MB_offset_ConfLZSHAWR		(0x101E - MB_Addr_ConfigAWR) 			// конфигурация ЛЗШ
...
#define MB_Addr_ConfigTRPWR		   	0x1047			// конфигурация  силового транса
#define MB_EndConfigTRPWR		   	0x105C
#define MB_Size_ConfigTRPWR			(MB_EndConfigTRPWR - MB_Addr_ConfigTRPWR)				// 21 слово
#define MB_offset_ConfigS1			(0x1048 - MB_Addr_ConfigTRPWR)
#define MB_offset_ConfigS2			(0x104E - MB_Addr_ConfigTRPWR)
#define MB_offset_ConfigS3			(0x1054 - MB_Addr_ConfigTRPWR)
...
#define MB_Addr_ConfigVLSIn			0x1074
#define MB_Size_ConfigVLSIn			(0x10B4 - MB_Addr_ConfigVLSIn)

// конфигурация выходных логических сигналов -------------------------------------
#define MB_Addr_ConfigVLSOut		0x10B4
#define MB_Size_ConfigVLSOut			(0x11B4 - MB_Addr_ConfigVLSOut)
...
// Группы уставок -----------------------------------------------------------------------------------
#define MB_Addr_Ustavkiaddr0	0x11B4			// Основная группа уставок
...
#define MB_offset_DIFFZ			(0x11C0 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации дифф защиты
#define MB_offset_DIFFOts		(0x11CC - MB_Addr_Ustavkiaddr0)		// адрес конфигурации дифф отсечки
#define MB_offset_DIFF0_1		(0x11D2 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации защиты нулевой последовательности
#define MB_offset_DIFF0_2		(0x11DC - MB_Addr_Ustavkiaddr0)		// адрес конфигурации защиты нулевой последовательности
#define MB_offset_DIFF0_3		(0x11E6 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации защиты нулевой последовательности
...
#define MB_offset_MTZ_I1		(0x11F0 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
#define MB_offset_Ig_I1								(0x1240 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
// U
#define MB_offset_Uup_U1		(0x127C - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
#define MB_offset_Udn_U1		(0x129C - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
// F
#define MB_offset_Fup_1		(0x12BC - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
#define MB_offset_Fdn_1		(0x12DC - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
// внешние
#define MB_offset_Ext_1		(0x1308 - MB_Addr_Ustavkiaddr0)		// адрес конфигурации ступени МТЗ защиты
...
#define MB_Size_Discreet   		0x23			// 0x22
...
#define MB_bOffset_errorM1		(1<<7)			// Наличие неисправности модуля 1 реле 8 + 2 реле выкл + 1 реле неиспр.		/ доп.дискреты 2
#define MB_bOffset_errorM2		(1<<8)			// Наличие неисправности модуля 2 реле 8 дискр. 8
#define MB_bOffset_errorM3		(1<<9)			// Наличие неисправности модуля 3 дискр. 16
#define MB_bOffset_errorM4		(1<<10)			// Наличие неисправности модуля 4 аналог только ТОК
#define MB_bOffset_errorM5		(1<<11)			// Наличие неисправности модуля 5 аналог ТОК и НАПРЯЖЕНИЕ
#define MB_bOffset_errorUstavki		(1<<12)			// Наличие неисправности уставок
#define MB_bOffset_errorUstavki	MB_bOffset_errorUstavki

#define MB_bOffset_errorALLModul		(0b111111<<7)	// Наличие любой неисправности

// ---------------------------------
#define MB_offset_errorHard1	(0x11)			// неисправность

#define MB_bOffset_errorSWAll	0b111100
...
#endif
#if (_REVISION_DEVICE>=	208)
#define MB_MaxNumbDiscreet		(24+2)
#endif
// --Discreet --
...
#if (_REVISION_DEVICE>=	208)
#define MB_offsetDiscreet_25	(0x0B)
#define MB_offsetDiscreet_26	(0x0C)
#endif
...
#if (_REVISION_DEVICE>=	208)
#define MB_bOffset_Discreet_25		BIT6
#define MB_bOffset_Discreet_26		BIT2
#endif
...
// ---------------------------------
#define MB_offset_IO_I1		0x04
#define MB_offset_IO_I2		0x04
#define MB_offset_IO_I3		0x04
#define MB_offset_IO_I4		0x04
#define MB_offset_IO_I5		0x04
#define MB_offset_IO_I6		0x04
#define MB_offset_IO_I7		0x04
#define MB_offset_IO_I8		0x05
...
#define MB_offset_SRAB_I1		0x04
#define MB_offset_SRAB_I2		0x04
#define MB_offset_SRAB_I3		0x04
#define MB_offset_SRAB_I4		0x04
#define MB_offset_SRAB_I5		0x04
#define MB_offset_SRAB_I6		0x04
#define MB_offset_SRAB_I7		0x05
#define MB_offset_SRAB_I8		0x05
...
#define MB_offset_IO_Ig1		0x05
#define MB_offset_IO_Ig2		0x05
#define MB_offset_IO_Ig3		0x05
#define MB_offset_IO_Ig4		0x05
#define MB_offset_IO_Ig5		0x05
#define MB_offset_IO_Ig6		0x05
...
#define MB_offset_SRAB_Ig1		0x05
#define MB_offset_SRAB_Ig2		0x05
#define MB_offset_SRAB_Ig3		0x05
#define MB_offset_SRAB_Ig4		0x05
#define MB_offset_SRAB_Ig5		0x05
#define MB_offset_SRAB_Ig6		0x05
...
#define MB_Size_Analog   		58			// 57 слов
...
#define MB_offset_Is30			32
#define MB_offset_Is32			33


#define MB_offset_U1n			36
#define MB_offset_U1a			37
#define MB_offset_U1b			38
#define MB_offset_U1c			39
#define MB_offset_U1ab			40
#define MB_offset_U1bc			41
#define MB_offset_U1cd			42
#define MB_offset_U10			43
#define MB_offset_U12			44

#define MB_offset_Il10			45
#define MB_offset_Il1a			46
#define MB_offset_Il1b			47
#define MB_offset_Il1c			48
#define MB_offset_Il20			49
#define MB_offset_Il2a			50
#define MB_offset_Il2b			51
#define MB_offset_Il2c			52
#define MB_offset_Il30			53
...
#define MB_Addr_Automat			0x155C
#define MB_Size_Automat			(0x15BE - MB_Addr_Automat + 1)

// Параметры системы (они же IP адрес) -----------------------------------------------------------
#define MB_Addr_SystemCfg		0x15BE
#define MB_Size_SystemCfg		10
...
/********************************************************************************
 * Область памяти для передачи своих состояний в базу прибора
 * MB_Size_My_Status
 ********************************************************************************/
// размер 256 слов предположительно будет одинаково во всех приборах
//

#define MB_Addr_My_Status   			(0x6900)
#define MB_offset_My_Status_addr		(0)				// отсюда читаю	адрес начала моего блока для доступа = любой который даст прибор.
#define MB_offset_My_Status_numPage		(1)				//							число страниц = 1
#define MB_offset_My_Status_sizePage	(2)				//							размер страницы = 256
//писать я буду 16 командой в диапазон между _addr и (_addr+_sizePage)
// ----------------------------------------------------------------------------------------------
...
#define MB_Addr_SWCrash			0x0410		// работает 0x1A00
...
#define MB_Size_DUMP_Ustavki	   	(0x15C1+128 - MB_Addr_DUMP_Ustavki)
// ----------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------
