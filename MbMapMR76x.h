...
#define _swREV			"MR761"
#define _swREVverify	"T4N4D42R19"
...
#define _swREV			"MR761"
#define _swREVverify	"T4N5D42R19"
	#if (_REVISION_DEVICE <= 302)
		#undef _REVISION_DEVICE
		#define _REVISION_DEVICE	303
	#endif
...
#define MB_SizeOscNote	   			100			//((MB_EndOscNoteaddr - MB_StartOscNoteaddr)/MB_NumbOscNote)			// число записей в журнале
...
// конфигурация АВР  ---------------------------------------------
#define MB_StartConfigAWR	   			(0x1220 - MB_StartConfig)			// конфигурация АВР в группе уставок
#define MB_NumbConfigAWR				0				// в уставках память не выделяем
...
#define MB_NumbConfigAPW				0				// в уставках память не выделяем				// 10 слов
...
#define MB_StartConfigMTZ_SG0  			(0x1004 - MB_StartUstavkiaddr0)
...
// Пуск дуговой защиты   ----------------------------------------------
#define MB_StartConfigARC	   						(0x10A0 - MB_StartUstavkiaddr0)			// конфигурация
...
#define MB_offset_BlkNStartMot						(0x1130 - MB_StartUstavkiaddr0)
...
#define MB_offset_P_1							(0x1208 - MB_StartUstavkiaddr0)
#define MB_offset_P_2							(0x1214 - MB_StartUstavkiaddr0)
...
#define MB_bOffsetErrorSWAll	0b111111100
...
#define MB_bOffsetUstavkiModify		(1<<0x0E)		// Изменения в уставках для версий приборов с гусами
...
// ----------------------------------------------------------------------------------------------
#define MB_StartRevNaddr   		0x0500		// версия 16 слов
#define MB_NumbWordRev	   		16			// 16 слов (в МР5 16 слов)
...
#define MB_offset_Automat				(0x294E - MB_StartOtherUstavkiaddr)
...
#define MB_StartSystemCfg				0x05C0
#define MB_NumbSystemCfg				16
...
#define MB_StartAutomat			0		// в уставках
#define MB_NumbAutomat			0

#define MB_StartConfigSW	  	0		// в уставках
