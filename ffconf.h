...
#define _VOLUME_STRS            "SPI","RAM","NAND","CF","SD1","SD2","USB1","USB2","USB3"
...
/* Чтобы включить функцию управления блокировкой файлов, установите _FS_LOCK ненулевым значением.
 * Значение определяет, сколько файлов/подкаталогов могут быть открыты одновременно
 * с контролем блокировки файлов. Эта функция использует bss _FS_LOCK * 12 байт.
*/
