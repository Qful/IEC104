...
typedef enum {
    ...
    M_SP_TA_1 = 2,
    M_DP_NA_1 = 3,		// двухэлементная информация
    M_DP_TA_1 = 4,
    M_ST_NA_1 = 5,		// информация о положении отпаек
    M_ST_TA_1 = 6,
    M_BO_NA_1 = 7,		// 32 битстринг
    M_BO_TA_1 = 8,
    M_ME_NA_1 = 9,		// значение измеряемой величины, нормализованное
    M_ME_TA_1 = 10,
    M_ME_NB_1 = 11,		// значение измеряемой величины, масштабированное
    M_ME_TB_1 = 12,
    M_ME_NC_1 = 13,		// значение измеряемой величины, короткий формат с плав. запятой.
    M_ME_TC_1 = 14,
    ...
    C_SE_TC_1 = 63,
    C_BO_TA_1 = 64,
    M_EI_NA_1 = 70,		// конец инициализации.

    C_IC_NA_1 = 100,	// команда опроса.
    C_CI_NA_1 = 101,	// команда опроса счётчика.
    C_RD_NA_1 = 102,	// команда считывание.
    C_CS_NA_1 = 103,	// команда синхронизации времени.
    C_TS_NA_1 = 104,
    C_RP_NA_1 = 105,	// команда установки процесса в исходное состояние.
    C_CD_NA_1 = 106,
    C_TS_TA_1 = 107,	// команда тестирования с меткой времени.
