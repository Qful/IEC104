...
void iecasdu_create_type_1 (u_char *buf, size_t *buflen)
{
	...
	type.sb = 1; /* замещение/нет замещения - значение поступает или от диспетчера или от автоматического источника*/
	type.nt = 1; /* неактуальное/актуальное - Актуально если большенство опросов успешно. Неактуально, если не обновлялось или было недоступно*/
