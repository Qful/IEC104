...
extern DataObject    iedModel_GenericIO_LLN0_SGCB;							// SGCB - Управление группами уставок
...
// Mod																// обязательные элементы -------------------------------------
extern DataObject    iedModel_GenericIO_MMXU1_Mod;					// РЕЖИМ
...
// Beh
extern DataObject    iedModel_GenericIO_MMXU1_Beh;					// РЕЖИМ РАБОТЫ
...
// Health
extern DataObject    iedModel_GenericIO_MMXU1_Health;				// СОСТОЯНИЕ РАБОТОСПОСОБНОСТИ
...
// NamPlt
extern DataObject    iedModel_GenericIO_MMXU1_NamPlt;				// ПАСПОРТНАЯ ТАБЛИЧКА
extern DataAttribute iedModel_GenericIO_MMXU1_NamPlt_vendor;		// 		Имя поставщика
extern DataAttribute iedModel_GenericIO_MMXU1_NamPlt_swRev;			// 		Ревизия программной части
extern DataAttribute iedModel_GenericIO_MMXU1_NamPlt_d;				//		Текстовое описание данных сдесь относится к логическому узлу LN MMXU1.
...
// Mod																// обязательные элементы -------------------------------------
extern DataObject    iedModel_GenericIO_PTOC1_Mod;					// РЕЖИМ
...
// Beh
extern DataObject    iedModel_GenericIO_PTOC1_Beh;					// РЕЖИМ РАБОТЫ
...
// Health
extern DataObject    iedModel_GenericIO_PTOC1_Health;				// СОСТОЯНИЕ РАБОТОСПОСОБНОСТИ
...
// NamPlt
extern DataObject    iedModel_GenericIO_PTOC1_NamPlt;				// ПАСПОРТНАЯ ТАБЛИЧКА
extern DataAttribute iedModel_GenericIO_PTOC1_NamPlt_vendor;		// 		Имя поставщика
extern DataAttribute iedModel_GenericIO_PTOC1_NamPlt_swRev;			// 		Ревизия программной части
extern DataAttribute iedModel_GenericIO_PTOC1_NamPlt_d;				//		Текстовое описание данных сдесь относится к логическому узлу LN PTOC1.
...
// Mod																// обязательные элементы -------------------------------------
extern DataObject    iedModel_GenericIO_CSWI1_Mod;					// РЕЖИМ
...
// Beh
extern DataObject    iedModel_GenericIO_CSWI1_Beh;					// РЕЖИМ РАБОТЫ
...
// Health
extern DataObject    iedModel_GenericIO_CSWI1_Health;				// СОСТОЯНИЕ РАБОТОСПОСОБНОСТИ
...
// NamPlt
extern DataObject    iedModel_GenericIO_CSWI1_NamPlt;				// ПАСПОРТНАЯ ТАБЛИЧКА
extern DataAttribute iedModel_GenericIO_CSWI1_NamPlt_vendor;		// 		Имя поставщика
extern DataAttribute iedModel_GenericIO_CSWI1_NamPlt_swRev;			// 		Ревизия программной части
extern DataAttribute iedModel_GenericIO_CSWI1_NamPlt_d;				//		Текстовое описание данных сдесь относится к логическому узлу LN CSWI1.
