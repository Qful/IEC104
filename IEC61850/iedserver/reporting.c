        ...
        MmsServerConnection connection)
{
    ...
    if (strcmp(elementName, "RptEna") == 0) {
        ...
        if (value->value.boolean == true) {
      	  ...
      	  // Отключим блокировку, т.к. поляки после реконнекта снова закидывают конфиг
  //TODO: Вернуть после выяснения причин.
  /*            if (rc->enabled == true) {
...
{
#define LOCAL_STORAGE_MEMORY_SIZE 	LOCAL_STORAGE_MEMORY
