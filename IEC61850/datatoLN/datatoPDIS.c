...
//  Mod Beh
		//PDIS1
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z1_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
		...
		//PDIS2
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z2_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
		...
		//PDIS3
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z3_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
		...
		//PDIS4
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z4_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
		...
		//PDIS5
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z5_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
		...
		//PDIS6
		if ((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z6_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
...
//  Quality (Mod Beh)
		...
		// при изменении качества, меняем и время
		if (IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS1_Mod_q,Qual)){
...
// Str_general
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS1_Str_general, &iedModel_PROT_PDIS1_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_1] & MB_Z1_IO)>0);
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS2_Str_general, &iedModel_PROT_PDIS2_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_2] & MB_Z2_IO)>0);
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS3_Str_general, &iedModel_PROT_PDIS3_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_3] & MB_Z3_IO)>0);
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS4_Str_general, &iedModel_PROT_PDIS4_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_4] & MB_Z4_IO)>0);
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS5_Str_general, &iedModel_PROT_PDIS5_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_5] & MB_Z5_IO)>0);
		IedServer_updateBooleanAttributeValueWithTime(iedServer, &iedModel_PROT_PDIS6_Str_general, &iedModel_PROT_PDIS6_Str_t, currentTime,  (ucMDiscInBuf[MB_IO_offsetZ_6] & MB_Z6_IO)>0);
...
//-------------
		// PDIS1
		if ((ucMDiscInBuf[MB_IO_offsetZ_1] & MB_Z1_IO)>0) {
				 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z1_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
			else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z1_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
...
//-------------
		// PDIS2
		if ((ucMDiscInBuf[MB_IO_offsetZ_2] & MB_Z2_IO)>0) {
			 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z2_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
		else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z2_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
		else Zsel = STVALCODEDENUM_UNKNOWN;//STVALCODEDENUM_BOTH;
		} else	Zsel = STVALCODEDENUM_UNKNOWN;
...
//-------------
		// PDIS3
		if ((ucMDiscInBuf[MB_IO_offsetZ_3] & MB_Z3_IO)>0) {
			 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z3_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
		else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z3_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
		else Zsel = STVALCODEDENUM_UNKNOWN;//STVALCODEDENUM_BOTH;
		} else Zsel = STVALCODEDENUM_UNKNOWN;
...
//-------------
		// PDIS4
		if ((ucMDiscInBuf[MB_IO_offsetZ_4] & MB_Z4_IO)>0) {
			 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z4_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
		else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z4_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
		else Zsel = STVALCODEDENUM_UNKNOWN;//STVALCODEDENUM_BOTH;
		} else Zsel = STVALCODEDENUM_UNKNOWN;
...
//-------------
		// PDIS5
		if ((ucMDiscInBuf[MB_IO_offsetZ_5] & MB_Z5_IO)>0) {
			 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z5_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
		else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z5_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
		else Zsel = STVALCODEDENUM_UNKNOWN;//STVALCODEDENUM_BOTH;
		} else Zsel = STVALCODEDENUM_UNKNOWN;
...
//-------------
		// PDIS6
		if ((ucMDiscInBuf[MB_IO_offsetZ_6] & MB_Z6_IO)>0) {
			 if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z6_Conf] & MB_bOffset_Z_Config_Napravl_up)>0) Zsel = STVALCODEDENUM_FORWARD;
		else if((ucMUstavkiInBuf[MB_Addr_Config_Z + MB_offset_Z6_Conf] & MB_bOffset_Z_Config_Napravl_dn)>0) Zsel = STVALCODEDENUM_BACKWARD;
		else Zsel = STVALCODEDENUM_UNKNOWN;//STVALCODEDENUM_BOTH;
		} else Zsel = STVALCODEDENUM_UNKNOWN;
...
//-------------
		...
		// при изменении качества, меняем и время
		if (IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS1_Str_q,quality)){
		...
		// при изменении качества, меняем и время
		if (IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS1_Op_q,quality)){
...
/*******************************************************
 * Set_PDIS наполняем оперативными данными
 *******************************************************/
int		Set_PDIS	(uint16_t QTnum, uint64_t currentTime )
{
	uint32_t	Health;
	...
	//  Mod Beh
				//PDIS1
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z1_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS1_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS1_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS1_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS1_Beh_t, currentTime);
				...
				//PDIS2
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z2_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS2_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS2_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS2_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS2_Beh_t, currentTime);
				...
				//PDIS3
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z3_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS3_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS3_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS3_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS3_Beh_t, currentTime);
				...
				//PDIS4
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z4_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS4_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS4_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS4_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS4_Beh_t, currentTime);
				...
				//PDIS5
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z5_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS5_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS5_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS5_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS5_Beh_t, currentTime);
				...
				//PDIS6
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z6_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS6_Mod_stVal, Mod)){
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS6_Mod_t, currentTime);
				if ( IedServer_updateInt32AttributeValue(iedServer, &iedModel_PROT_PDIS6_Beh_stVal, Mod))
					IedServer_updateUTCTimeAttributeValue(iedServer,&iedModel_PROT_PDIS6_Beh_t, currentTime);
...
#if defined	(MR771)
				//PDIS7
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z7_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				...
				//PDIS8
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z8_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				...
				//PDIS9
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z9_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
				...
				//PDIS10
				if ((ucMUstavkiInBuf[MB_StartConfig_Z + MB_offset_Z10_Conf] & MB_bOffset_Z_Config_Stat)>0) {Mod = STVALINT32_ON;} else {Mod = STVALINT32_OFF;}
