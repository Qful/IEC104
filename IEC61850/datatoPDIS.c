 ...
 *******************************************************/
void	Set_PDIS	(uint8_t num, uint64_t currentTime )
{
	uint32_t	Health;
	uint32_t	Mod;
	int16_t		Zsel;
	...
	// Str_general
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS1_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_1] & MB_Z1_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS2_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_2] & MB_Z2_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS3_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_3] & MB_Z3_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS4_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_4] & MB_Z4_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS5_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_5] & MB_Z5_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS6_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_6] & MB_Z6_IO);
#if defined	(MR771)
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS7_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_7] & MB_Z7_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS8_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_8] & MB_Z8_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS9_Str_general,  ucMDiscInBuf[MB_IO_offsetZ_9] & MB_Z9_IO);
				IedServer_updateBooleanAttributeValue(iedServer, &iedModel_PROT_PDIS10_Str_general, ucMDiscInBuf[MB_IO_offsetZ_10] & MB_Z10_IO);
#endif
...
//-------------
	...
	Qual = 0;
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS1_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS2_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS3_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS4_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS5_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS6_Str_q,Qual);
#if defined	(MR771)
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS7_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS8_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS9_Str_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS10_Str_q,Qual);
#endif
...
#endif
	Qual = 0;
    IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS1_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS2_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS3_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS4_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS5_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS6_Op_q,Qual);
#if defined	(MR771)
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS7_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS8_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS9_Op_q,Qual);
	IedServer_updateQuality(iedServer,&iedModel_PROT_PDIS10_Op_q,Qual);
#endif
}
